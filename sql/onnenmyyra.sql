...
--
-- Host: localhost    Database: onnenmyyra
-- ------------------------------------------------------
...
CREATE TABLE `content` (
  ...
  `kirje` text COLLATE utf8_swedish_ci NOT NULL,
...
CREATE TABLE `kayttajat` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `kayttaja` varchar(255) COLLATE utf8_swedish_ci NOT NULL,
...
INSERT INTO `kayttajat` VALUES (1,'yllapito','600c45392c9beb9dcdbfd86ead599a9b');
...
-- Dump completed on 2012-11-12 12:07:24
